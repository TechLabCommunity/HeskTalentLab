...
// --> General settings
$hesk_settings['site_title']='TalentLab';
$hesk_settings['site_url']='https://ticketing.talentlabpadova.org';
$hesk_settings['hesk_title']='TalentLab Help Desk';
$hesk_settings['hesk_url']='https://ticketing.talentlabpadova.org';
$hesk_settings['webmaster_mail']='support@example.com';
$hesk_settings['noreply_mail']='support@example.com';
$hesk_settings['noreply_name']='TalentLab Help Desk';

// --> Language settings
$hesk_settings['can_sel_lang']=0;
$hesk_settings['language']='Italiano';
$hesk_settings['languages']=array(
'Italiano' => array('folder'=>'en','hr'=>'------ Rispondi sopra questa riga ------'),
);

// --> Database settings
$hesk_settings['db_host']='localhost';
$hesk_settings['db_name']='talentla_hesk';
$hesk_settings['db_user']='talentla_ticket';
$hesk_settings['db_pass']='0fYnZCTSLfXe4n';
...
$hesk_settings['secimg_sum']='UV3GTVXWXJ';
...
$hesk_settings['smtp_user']='gestione@talent-lab.it';
$hesk_settings['smtp_password']='Qs3F3W9i';
...
// --> Date & Time
$hesk_settings['timezone']='Europe/Rome';
